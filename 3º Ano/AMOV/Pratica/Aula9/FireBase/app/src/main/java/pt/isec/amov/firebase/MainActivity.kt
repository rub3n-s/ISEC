...
import pt.isec.amov.firebase.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val strPass get() = binding.edEmail.text.toString()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent.extras?.apply {
            for(k in keySet()) {
                Log.i(MyFirebaseMessagingService.TAG, "Extras: $k -> ${get(k)}")
            }
        }
    ...
    fun onLogoutEmail(view : View) { signOut() }
    ...
    fun onLogoutGmail(view : View) { signOutGoogle() }
    fun signOutGoogle() {
        if (auth.currentUser != null) {
    ...
    fun onAddNewData(view : View) { addDataToFirestore() }
    ...
    fun onUpdateData(view : View) { updateDataInFirestoreTrans() }
    ...
    fun onRemoveData(view : View) { removeDataFromFirestore() }
    ...
    fun onObserveData(view : View) { startObserver() }
