...
public class PiCalculator implements Serializable
{
    ...
    public PiCalculator(int myId, int nWorkers, long nIntervals) {
        this.myId = myId;
        this.nWorkers = nWorkers;
        this.nIntervals = nIntervals;
    }

    public double getPartialPiValue(int myId, int nWorkers, long nIntervals)
    {
        long i;
        double dX, xi, result;
    ...
    public long getIntervals() { return nIntervals; }
