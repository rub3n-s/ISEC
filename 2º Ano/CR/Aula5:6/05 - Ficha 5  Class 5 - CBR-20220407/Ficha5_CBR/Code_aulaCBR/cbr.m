function [] = cbr()
    ...
    %% e)1) Execute o sistema e faça variar os seguintes parametros para
    % perceber o impacto que tem nos resultados obtidos:
    % Threshold minimo de semelhança.

    % quanto maior for o valor, menor serao os casos de semelhança
