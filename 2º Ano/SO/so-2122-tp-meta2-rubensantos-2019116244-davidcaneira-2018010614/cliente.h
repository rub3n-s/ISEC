#ifndef TP_SO_RUBENSANTOS_2019116244_CLIENTE_H
#define TP_SO_RUBENSANTOS_2019116244_CLIENTE_H
...
void trataSinal(int s, siginfo_t *info, void *c);
void trataSig(int i);
