...
void main(int argc, char **argv)
{
	...
	if(sendto(s, GET_TIME, strlen(GET_TIME), 0, (struct sockaddr *)&serv_addr, sizeof(serv_addr)) == SOCKET_ERROR){
	...
	if((nbytes = recvfrom(s, response, MAX_MSG_SIZE, 0, NULL, NULL)) == SOCKET_ERROR){
